...
rem --- Copying : Exe ---
xcopy ..\Project\MSVC2015\x64\Release\MediaConch.exe MediaConch_CLI_Windows_x64\ /S
xcopy ..\Project\MSVC2015\x64\Release\LIBCURL.DLL MediaConch_CLI_Windows_x64\ /S
...
..\..\..\..\MediaArea-Utils-Binaries\Windows\7-Zip\7z a -r -tzip ..\MediaConch_CLI_Windows_x64.zip *
cd ..
