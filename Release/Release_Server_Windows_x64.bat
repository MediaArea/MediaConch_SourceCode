...
rem --- Copying : Exe ---
xcopy ..\Project\MSVC2019\x64\Release\MediaConch.exe MediaConch_Server_Windows_x64\ /S
xcopy ..\Project\MSVC2019\x64\Release\LIBCURL.DLL MediaConch_Server_Windows_x64\ /S
