...
rem --- Copying : Exe ---
xcopy ..\Project\MSVC2017\Win32\Release\MediaConch.exe MediaConch_Server_Windows_i386\ /S
xcopy ..\Project\MSVC2017\Win32\Release\LIBCURL.DLL MediaConch_Server_Windows_i386\ /S
