...
//---------------------------------------------------------------------------
LoadPolicyPathBox::LoadPolicyPathBox(const QString& value) : QMessageBox(NULL), path(value)
{
    setText("Default folder to open policy:");
...
//---------------------------------------------------------------------------
LoadPolicyPathBox::~LoadPolicyPathBox()
{
...
//---------------------------------------------------------------------------
QString LoadPolicyPathBox::get_path()
{
