...
//---------------------------------------------------------------------------
LoadDisplayPathBox::LoadDisplayPathBox(const QString& value) : QMessageBox(NULL), path(value)
{
    setText("Default folder to open display:");
...
//---------------------------------------------------------------------------
LoadDisplayPathBox::~LoadDisplayPathBox()
{
...
//---------------------------------------------------------------------------
QString LoadDisplayPathBox::get_path()
{
