...
int get_generated_values_from_csv(std::map<std::string, std::map<std::string, std::vector<std::string> > >& values)
{
    ...
    }
    {
        ...
        }
        {
            ...
            tmp_vec.push_back("1.3");
            tmp_vec.push_back("2");
            tmp_vec.push_back("2 / 2");
            tmp_vec.push_back("2.0");
            tmp_vec.push_back("2.1");
            tmp_vec.push_back("2.2");
            tmp_vec.push_back("3");
            tmp_vec.push_back("3.0");
            tmp_vec.push_back("3.1");
            tmp_vec.push_back("3.1 / 3.1");
            tmp_vec.push_back("3.2");
            tmp_vec.push_back("4");
            tmp_vec.push_back("4 / 25.5");
            tmp_vec.push_back("4 / 4.1");
            tmp_vec.push_back("4.0");
            tmp_vec.push_back("4.1");
            tmp_vec.push_back("4.1 / 4.1");
            tmp_vec.push_back("4.2");
            tmp_vec.push_back("4a");
            tmp_vec.push_back("5");
            tmp_vec.push_back("5.1");
            tmp_vec.push_back("5.2");
            tmp_vec.push_back("6.0");
            tmp_vec.push_back("6.2");
            tmp_vec.push_back("7");
            tmp_vec.push_back("HL");
            tmp_vec.push_back("High");
            tmp_vec.push_back("High 1440");
            tmp_vec.push_back("LL");
            tmp_vec.push_back("Low");
            tmp_vec.push_back("ML");
            tmp_vec.push_back("Main");
            tmp["Format_Level"] = tmp_vec;
        }
        {
            std::vector<std::string> tmp_vec;
            tmp_vec.push_back("422");
            tmp_vec.push_back("422 HQ");
            tmp_vec.push_back("422 LT");
            tmp_vec.push_back("422 Proxy");
            tmp_vec.push_back("4444");
            tmp_vec.push_back("4:2:2");
            tmp_vec.push_back("Advanced");
            tmp_vec.push_back("Advanced Simple");
            tmp_vec.push_back("Alpha channel");
            tmp_vec.push_back("BCMR");
            tmp_vec.push_back("BCS");
            tmp_vec.push_back("Base");
            tmp_vec.push_back("BaseLine");
            tmp_vec.push_back("Baseline");
            tmp_vec.push_back("D-Cinema 2k");
            tmp_vec.push_back("D-Cinema 4k");
            tmp_vec.push_back("Heightened Sharpness");
            tmp_vec.push_back("High");
            tmp_vec.push_back("High 10");
            tmp_vec.push_back("High 10 Intra");
            tmp_vec.push_back("High 4:2:2");
            tmp_vec.push_back("High 4:2:2 Intra");
            tmp_vec.push_back("Line");
            tmp_vec.push_back("MP");
            tmp_vec.push_back("Main");
            tmp_vec.push_back("Main 10");
            tmp_vec.push_back("Multiview High / High");
            tmp_vec.push_back("No restrictions");
            tmp_vec.push_back("Profile-0");
            tmp_vec.push_back("Simple");
            tmp_vec.push_back("Simple Studio");
            tmp_vec.push_back("Stereo High");
            tmp_vec.push_back("Stereo High / High");
            tmp["Format_Profile"] = tmp_vec;
        }
        {
            std::vector<std::string> tmp_vec;
