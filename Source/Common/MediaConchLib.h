...
public:
    ...
    struct Checker_ReportRes
    {
        ...
        bool                  has_warning;
        bool                  valid;
        Checker_ReportRes() : has_valid(false), has_info(false), has_warning(false), valid(true) {}
    };
    ...
    struct Checker_ValidateRes
    {
        ...
        bool                    has_info;
        bool                    has_warning;
        Checker_ValidateRes() : valid(true), has_info(false), has_warning(false) {}
    };
    ...
    struct Policy_Policy
    {
        ...
        Policy_Policy(const Policy_Policy* p) : id(p->id), parent_id(p->parent_id), is_system(p->is_system), is_public(p->is_public), kind(p->kind), type(p->type), name(p->name), description(p->description), tags(p->tags), level(p->level), license(p->license), children(p->children) {}
        int                                       id;
        int                                       parent_id;
        bool                                      is_system;
        bool                                      is_public;
