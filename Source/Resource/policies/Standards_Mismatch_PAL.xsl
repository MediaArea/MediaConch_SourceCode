      ...
      <xsl:for-each select="ma:media">
        <media>
          ...
          <policyChecks>
            ...
            <description>This policy checks files for a framesize of 720x576, interlaced, and a framerate of 25.</description>
            <check>
            ...
            <check>
              <xsl:attribute name="name">Video Height must be 576</xsl:attribute>
              <context>
