...
function policyEditHelp() {
    ...
    // Push to mco
    popoverHelp.add('.policyPush', 'You can add your policy to MediaConchOnline.<ul><li>Public: the policy is added to your policies list and also to the public policy page to share it with everyone</li><li>Private: the policy is added to your policies list but is only available for you</li></ul>', 'Push policy', 'policyPush');
}
