...
Build-Depends: debhelper (>= 9), dh-autoreconf, tofrodos, libmediainfo-dev (>= 18.03.1), libzen-dev (>= 0.4.37), libqt4-dev, libxml2-dev, libxslt-dev, libsqlite3-dev, libjansson-dev, zlib1g-dev, pkg-config, automake, autoconf, libtool, libqtwebkit-dev, libcurl4-gnutls-dev, libevent-dev
Package-List:
