...
xcopy /D %1\bin\Qt5WebEngine.dll %2 | find /v "0 " || cd %CD%
xcopy /D %1\bin\Qt5WebEngineWidgets.dll %2 | find /v "0 " || cd %CD%
xcopy /D %1\bin\Qt5WebEngineCore.dll %2 | find /v "0 " || cd %CD%
...
xcopy /D %1\bin\Qt5WebEngined.dll %2 | find /v "0 " || cd %CD%
xcopy /D %1\bin\Qt5WebEngineWidgetsd.dll %2 | find /v "0 " || cd %CD%
xcopy /D %1\bin\Qt5WebEngineCored.dll %2 | find /v "0 " || cd %CD%
