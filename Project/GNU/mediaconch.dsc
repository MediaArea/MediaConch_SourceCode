...
Build-Depends: debhelper (>= 9), dh-autoreconf, tofrodos, libmediainfo-dev (>= 0.7.78), libzen-dev (>= 0.4.29), libqt4-dev, libxml2-dev, libxslt-dev, zlib1g-dev, pkg-config, automake, autoconf, libtool, libqtwebkit-dev, libcurl4-gnutls-dev
Package-List:
